...
def apply_chart_theme(fig: go.Figure, theme: str = "Light", title: str = None) -> go.Figure:
    """
...
def create_line_chart(data, x_col: str, y_col: str, title: str, 
                     theme: str = "Light", color: str = None, **kwargs) -> go.Figure:
    """
...
def create_bar_chart(data, x_col: str, y_col: str, title: str,
                    theme: str = "Light", color_col: str = None, **kwargs) -> go.Figure:
    """
    ...
    if not color_discrete_map and color_col:
        ...
        color_discrete_map = {val: QUALITATIVE_COLORS[i % len(QUALITATIVE_COLORS)] 
...
def create_pie_chart(data, values_col: str, names_col: str, title: str,
                    theme: str = "Light", **kwargs) -> go.Figure:
    """
    ...
    fig = px.pie(data, values=values_col, names=names_col,
                color_discrete_sequence=QUALITATIVE_COLORS, **kwargs)
...
def create_scatter_chart(data, x_col: str, y_col: str, title: str,
                        theme: str = "Light", size_col: str = None, 
...
def create_area_chart(data, x_col: str, y_col: str, title: str,
                     theme: str = "Light", color_col: str = None, **kwargs) -> go.Figure:
    """
...
def add_chart_annotations(fig: go.Figure, annotations: List[Dict[str, Any]]) -> go.Figure:
    """
    ...
    for annotation in annotations:
        fig.add_annotation(
            ...
            font=dict(
                size=12,
                color=annotation.get('color', COLORS['primary'])
            ),
...
def get_color_palette(n_colors: int, palette_type: str = "qualitative") -> List[str]:
    ...
    if palette_type == "sequential":
        ...
        if n_colors <= len(QUALITATIVE_COLORS):
            ...
            return (QUALITATIVE_COLORS * ((n_colors // len(QUALITATIVE_COLORS)) + 1))[:n_colors]